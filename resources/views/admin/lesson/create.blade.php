...
@section('content')
    ...
    <form action="{{route('admin.lesson.store')}}" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="is_commend" value="1"
                                       @if(old('is_commend') == 1) checked @endif>是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_commend" value="0"
                                       @if(old('is_commend') == 0) checked @endif> 否
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="is_hot" value="1" @if(old('is_hot') == 1) checked @endif>是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_hot" value="0" @if(old('is_hot') == 0) checked @endif> 否
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="click_count" min="0" value="{{old('click_count')}}"
                                   class="form-control">
                        </div>
                    </div>
                </div>
